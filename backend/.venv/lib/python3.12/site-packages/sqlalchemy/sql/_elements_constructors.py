...
def cast(
    ...
    E.g.::
        ...
        stmt = select(cast(book_table.c.unit_price, Numeric(10, 4)))

    The above statement will produce SQL resembling::

        SELECT CAST(unit_price AS NUMERIC(10, 4)) FROM book
...
def try_cast(
    ...
    E.g.::
        ...
        stmt = select(
            try_cast(book_table.c.unit_price, Numeric(10, 4))
        )

    The above would render on Microsoft SQL Server as::

        SELECT TRY_CAST (book_table.unit_price AS NUMERIC(10, 4))
        FROM book_table
